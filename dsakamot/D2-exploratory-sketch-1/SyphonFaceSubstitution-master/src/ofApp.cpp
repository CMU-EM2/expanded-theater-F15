...
void ofApp::setup() {
   ...
   // fboSyphonOut.allocate(camSize.x, camSize.y, GL_RGB);
    ...
    //SYPHONNNN
    syphonMask.setup();
    syphonMask.setApplicationName("Multiple PS3 eye and syphon");
    syphonMask.setServerName("Camera 1 Output");
    syphonInputCam.setup();
    syphonInputCam.setApplicationName("SyphonCamera");
    syphonInputCam.setServerName("FaceTime HD Camera");
